...
*/
  ...
  #define PRI_INPUT2          2, -1000, 0, 1000, 120    // Active.   TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #define INPUT_BRK           -700      // (-1000 - 0) Change this value to adjust the braking amount

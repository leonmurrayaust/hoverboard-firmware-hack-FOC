...
#define BAT_CALIB_REAL_VOLTAGE  3890      // input voltage measured by multimeter (multiplied by 100). In this case 43.00 V * 100 = 4300
...
#define N_MOT_MAX       252             // [rpm] Maximum motor speed limit
...
#define PHASE_ADV_MAX    15              // [deg] Maximum Phase Advance angle (only for SIN). Higher angle results in higher maximum speed.
...
*/
  ...
  #define PRI_INPUT1            1, 0, 500, 1000, 0      // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #define PRI_INPUT2            1, 0, 500, 1000, 0      // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #ifdef DUAL_INPUTS
    ...
    #define AUX_INPUT1          3, 0, 500, 1000, 0  // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
    #define AUX_INPUT2          3, 0, 500, 1000, 0  // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #else
    #define FLASH_WRITE_KEY     0x1001    // Flash memory writing key= 0x1001 Change this key to ignore the input calibrations from the flash memory and use the ones in config.h
    #define DEBUG_SERIAL_USART3           // right sensor board cable, disable if I2C (nunchuk or lcd) is used!
  #endif
...
*/
  ...
  #undef  CTRL_MOD_REQ
  #define CTRL_MOD_REQ        VLT_MODE  // SKATEBOARD works best in TORQUE Mode
  // #define CONTROL_PWM_LEFT    0         // use RC PWM as input on the LEFT cable. Number indicates priority for dual-input. Disable DEBUG_SERIAL_USART2!
  #define CONTROL_PWM_RIGHT   0         // use RC PWM as input on the RIGHT cable.  Number indicates priority for dual-input. Disable DEBUG_SERIAL_USART3!

  #define PRI_INPUT1          0, -1000, 0, 2000,   0    // Disabled. TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #define PRI_INPUT2          2, -2000, 0, 2000, 150    // Active.   TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #define INPUT_BRK           -800      // (-1000 - 0) Change this value to adjust the braking amount

  #define FILTER              13270      // 0.1f [-] fixdt(0,16,16) lower value == softer filter [0, 65535] = [0.0 - 1.0].
  #define SPEED_COEFFICIENT   16384     // 1.0f [-] fixdt(1,16,14) higher value == stronger. [0, 65535] = [-2.0 - 2.0]. In this case 16384 = 1.0 * 2^14

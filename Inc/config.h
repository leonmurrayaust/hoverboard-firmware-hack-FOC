...
*/
  ...
  #define PRI_INPUT2          2, -800, 0, 800, 150    // Active.   TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #define INPUT_BRK           -600      // (-1000 - 0) Change this value to adjust the braking amount
